...
function SettingPage() {
  ...
  const handleCopy = () => {
    const code = `<script src="https://cdn.jsdelivr.net/gh/boyhaimai/model_admin_just_chat_v19@main/dist/model_admin_just_chat.js" data-server-url="${form.serverUrl}" data-id-config="${id_config}" defer></script>`;
    navigator.clipboard
      .writeText(code)
      .then(() => {
        setCopySuccess(true);
                ...
                <Box sx={{ mb: 2, position: "relative" }}>
                  ...
                  >
                    <TextField
                      ...
                      multiline
                      rows={8}
                      value={`<script src="https://cdn.jsdelivr.net/gh/boyhaimai/model_admin_just_chat_v19@main/dist/model_admin_just_chat.js" data-server-url="${form.serverUrl}" data-id-config="${id_config}" defer></script>`}
                      InputProps={{
