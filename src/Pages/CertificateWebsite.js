  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const scriptPattern = new RegExp(
        `<script src="https://cdn.jsdelivr.net/gh/boyhaimai/model_admin_just_chat_v3@main/dist/model_admin_just_chat.js" data-server-url="https://ai.bang.vawayai.com:5000" data-id-config=${configId} defer></script>`
          .replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&")
      );
