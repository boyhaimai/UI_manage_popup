  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const scriptPattern = new RegExp(
        `<script\\s+src="https://cdn.jsdelivr.net/gh/boyhaimai/model_admin_just_chat_v3@main/dist/model_admin_just_chat.js"\\s+data-server-url="https://https://ai.bang.vawayai.com:5000:5000"\\s+data-id-config="${configId}"\\s+defer></script>`
          .replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&")
      );
